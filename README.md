## run_analysis.R : R-script on Human Activity Recognition using datasets from smartphones
...
A more complete description of the "tidy_movement_data.txt" file can be found in the "CodeBook.md" file.
